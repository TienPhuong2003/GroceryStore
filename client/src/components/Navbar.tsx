        ...
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          <div className="flex items-center gap-3">
            <button className="relative" onClick={() => setIsCartOpen(true)}>
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 size-3 bg-app-orange text-white text-[10px] rounded-full flex-center">
                  {cartCount}
                </span>
              )}
            </button>
            ...
            <div className="relative">
              {user ? (
                ...
                <div className="flex-center gap-2">
                  <Link
                    to="/login"
                    className="hidden md:flex items-center gap-2 py-2 px-4 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-950-light transition-colors"
                  >
              ...
              {userMenuOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-spin">
                    {user && (
