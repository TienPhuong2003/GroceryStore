...
const CartSidebar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animate-slide-in-left">
          ...
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            {deliveryFee > 0 && (
              <p className="text-xs text-app-text-light text-center">
                FREE DELIVERY an order over {currency}20!
              </p>
            )}
            ...
            <button
              ...
              className="w-full py-3 bg-app-orange text-white font-semibold rounded-xl hover:bg-app-orange-dark transition-colors flex-center gap-2 active:scale-0-[0.98]"
            >
