...
const Products = () => {
  ...
  const maxPrice = searchParams.get("maxPrice") || 1;
  ...
  return (
    <div className="min-h-screen bgb-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <nav className=" flex items-center gap-2 text-sm text-app-text-lightmb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none pl-3 pr-8 py-2 text-sm bg-white round-xl border border-app-border focus:border-app-green outline-none cursor-pointer"
                  >
